...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fo(e,t,n){let r=new Float32Array(xo),i=new H(0,1,0);return new ha({name:`SphericalGaussianBlur`,defines:{n:xo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ro(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Io(){return new ha({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ro(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Lo(){return new ha({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ro(),fragmentShader:`
	...
	`}var zo=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new G([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var uc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function dc(e,t){let n=uc[t];return n===void 0?(R(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var fc=new H;function pc(){return W.getLuminanceCoefficients(fc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${fc.x.toFixed(4)}, ${fc.y.toFixed(4)}, ${fc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=nc(i,i.VERTEX_SHADER,y),S=nc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=cc(i,x,`vertex`),n=cc(i,S,`fragment`);z(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),(0,Y.jsx)(`div`,{style:{position:`absolute`,inset:0,pointerEvents:`none`,background:`radial-gradient(ellipse at center, transparent 25%, rgba(4,12,26,0.55) 100%)`}}),h===`intro`&&(0,Y.jsx)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,alignItems:`center`,justifyContent:`center`,opacity:b?1:0,transition:`opacity 0.7s ease`,pointerEvents:`none`},children:(0,Y.jsxs)(`p`,{style:{fontSize:10,letterSpacing:`0.36em`,color:`#60A5FA`,fontFamily:Ml,fontWeight:400,margin:0,textShadow:`0 0 28px rgba(96,165,250,0.7)`},children:[v,v.length<33&&(0,Y.jsx)(`span`,{style:{animation:`blink 0.7s infinite`},children:`_`})]})}),Te&&(0,Y.jsxs)(Y.Fragment,{children:[S>0&&h!==`traveling`&&(0,Y.jsx)(`button`,{className:`back-btn`,onClick:le,style:{position:`absolute`,top:20,left:18,zIndex:10,background:`none`,border:`none`,color:`rgba(147,197,253,0.38)`,fontSize:9,letterSpacing:`0.22em`,fontFamily:Ml,fontWeight:400,cursor:`pointer`,padding:`8px 4px`,opacity:.7,display:`flex`,alignItems:`center`,gap:6,transition:`opacity 0.2s ease`},children:`← BACK`}),(0,Y.jsxs)(`div`,{style:{position:`absolute`,top:0,left:0,right:0,background:`linear-gradient(180deg, rgba(4,12,26,0.82) 0%, transparent 100%)`,padding:`52px 22px 64px`,display:`flex`,flexDirection:`column`,alignItems:`center`,pointerEvents:`none`},children:[(0,Y.jsxs)(`p`,{style:{fontSize:9,letterSpacing:`0.34em`,color:`rgba(96,165,250,0.4)`,fontFamily:Ml,margin:`0 0 12px`},children:[String(S+1).padStart(2,`0`),` / `,Tl]}),(0,Y.jsx)(`div`,{style:{display:`flex`,gap:3,marginBottom:26,flexWrap:`wrap`,justifyContent:`center`,maxWidth:320},children:Array.from({length:Tl},(e,t)=>(0,Y.jsx)(`div`,{style:{width:t===S?14:4,height:4,borderRadius:2,background:t<xe?`#3B82F6`:t===S?`#60A5FA`:`rgba(96,165,250,0.13)`,transition:`all 0.4s ease`,boxShadow:t===S?`0 0 7px rgba(96,165,250,0.65)`:`none`}},t))}),(0,Y.jsxs)(`h2`,{style:{color:`#FFFFFF`,fontSize:28,fontWeight:800,letterSpacing:`0.05em`,textAlign:`center`,textTransform:`uppercase`,fontFamily:Nl,margin:0,lineHeight:1.3,maxWidth:360,textShadow:`0 0 44px rgba(37,99,235,0.7), 0 2px 14px rgba(0,0,0,0.95)`,minHeight:72},children:[w,h===`question`&&!E&&(0,Y.jsx)(`span`,{style:{fontWeight:300,animation:`blink 0.75s infinite`},children:`|`})]}),pe?.sub&&E&&(0,Y.jsx)(`p`,{style:{color:`rgba(96,165,250,0.5)`,fontSize:9,letterSpacing:`0.22em`,fontFamily:Ml,margin:`12px 0 0`,textAlign:`center`},children:pe.sub})]}),E&&(0,Y.jsx)(`div`,{style:{position:`absolute`,bottom:0,left:0,right:0},children:(0,Y.jsxs)(`div`,{style:{background:`linear-gradient(0deg, rgba(4,12,26,0.98) 60%, rgba(4,12,26,0) 100%)`,padding:`48px 18px 32px`},children:[ge&&(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsx)(`div`,{className:`quiz-scroll`,style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:9,maxHeight:`46vh`,overflowY:`auto`,scrollbarWidth:`none`},children:me.map((e,t)=>{let n=k.indexOf(e),r=n===-1?0:n+1,i=r>0,a=r===1?`rgba(96,165,250,0.95)`:r===2?`rgba(130,110,255,0.70)`:r===3?`rgba(96,165,250,0.42)`:`rgba(96,165,250,0.2)`,o=r===1?`0 0 26px rgba(96,165,250,0.42), 0 0 8px rgba(96,165,250,0.18) inset`:r===2?`0 0 18px rgba(130,110,255,0.30)`:r===3?`0 0 10px rgba(96,165,250,0.18)`:`none`,s={width:6,height:6,borderRadius:`50%`,background:r===2?`#B09FFF`:`#60A5FA`,boxShadow:r===2?`0 0 7px rgba(130,110,255,0.95), 0 0 14px rgba(130,110,255,0.55)`:`0 0 7px rgba(96,165,250,0.95), 0 0 14px rgba(96,165,250,0.55)`,display:`block`,flexShrink:0};return(0,Y.jsxs)(`button`,{className:`pill-btn`,onClick:()=>de(e),style:{...Ce(i),border:`1px solid ${a}`,boxShadow:o,overflow:`hidden`,animation:`pillIn 0.32s ease both`,animationDelay:`${t*60}ms`},children:[r===1&&(0,Y.jsx)(`span`,{style:{position:`absolute`,top:9,right:11,pointerEvents:`none`},children:(0,Y.jsx)(`span`,{style:{...s}})}),r===2&&(0,Y.jsxs)(`span`,{style:{position:`absolute`,top:9,right:9,display:`flex`,gap:4,pointerEvents:`none`},children:[(0,Y.jsx)(`span`,{style:{...s}}),(0,Y.jsx)(`span`,{style:{...s}})]}),r===3&&(0,Y.jsxs)(`span`,{style:{position:`absolute`,top:7,right:9,width:18,height:15,pointerEvents:`none`},children:[(0,Y.jsx)(`span`,{style:{...s,position:`absolute`,top:0,left:0}}),(0,Y.jsx)(`span`,{style:{...s,position:`absolute`,top:0,right:0}}),(0,Y.jsx)(`span`,{style:{...s,position:`absolute`,bottom:0,left:`50%`,transform:`translateX(-50%)`}})]}),e]},e)})}),(0,Y.jsx)(`div`,{style:{marginTop:12},children:(0,Y.jsx)(`button`,{className:k.length>=2?`q-pulse`:``,onClick:P,style:we(k.length>=2),children:`NEXT →`})})]}),_e&&(0,Y.jsx)(`div`,{style:{animation:`pillIn 0.4s ease both`},children:(0,Y.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,gap:10,marginBottom:12},children:[1,2,3,4,5].map((e,t)=>{let n=A[S]===e;return(0,Y.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:8,flex:1},children:[(0,Y.jsx)(`button`,{onClick:()=>M(e),style:{width:`100%`,aspectRatio:`1`,maxWidth:62,borderRadius:`50%`,background:n?`rgba(37,99,235,0.2)`:`rgba(4,12,26,0.6)`,border:`1.5px solid ${n?`rgba(96,165,250,0.9)`:`rgba(96,165,250,0.22)`}`,boxShadow:n?`0 0 26px rgba(96,165,250,0.45)`:`none`,color:n?`#DBEAFE`:`rgba(147,197,253,0.6)`,fontSize:20,fontWeight:700,fontFamily:Ml,cursor:`pointer`,transition:`all 0.28s ease`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:e}),(0,Y.jsx)(`span`,{style:{fontSize:8,letterSpacing:`0.1em`,color:`rgba(147,197,253,0.45)`,fontFamily:Ml,textAlign:`center`,lineHeight:1.3,minHeight:22,maxWidth:62},children:Al[t]})]},e)})})}),ve&&(0,Y.jsxs)(`div`,{style:{animation:`pillIn 0.4s ease both`,padding:`0 4px`},children:[(0,Y.jsx)(`div`,{style:{textAlign:`center`,fontSize:56,fontWeight:800,color:`#60A5FA`,fontFamily:Nl,lineHeight:1,marginBottom:8,textShadow:`0 0 32px rgba(96,165,250,0.6)`},children:ne}),(0,Y.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,marginBottom:0},children:[(0,Y.jsx)(`span`,{style:{fontSize:9,letterSpacing:`0.16em`,color:`rgba(147,197,253,0.45)`,fontFamily:Ml},children:`TERRIBLE`}),(0,Y.jsx)(`span`,{style:{fontSize:9,letterSpacing:`0.16em`,color:`rgba(147,197,253,0.45)`,fontFamily:Ml},children:`PERFECT`})]}),(0,Y.jsx)(`input`,{type:`range`,className:`quiz-slider`,min:`1`,max:`10`,step:`1`,value:ne,onChange:e=>re(Number(e.target.value)),style:{"--val":Se}}),(0,Y.jsx)(`button`,{className:`q-pulse`,onClick:()=>M(ne),style:{...we(!0),marginTop:10},children:`NEXT →`})]}),(ye||he)&&(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsx)(`div`,{className:`quiz-scroll`,style:{display:be?`grid`:`flex`,gridTemplateColumns:be?`1fr 1fr`:void 0,flexDirection:be?void 0:`column`,alignItems:be?void 0:`center`,gap:9,maxHeight:`44vh`,overflowY:`auto`,scrollbarWidth:`none`},children:me.map((e,t)=>(0,Y.jsx)(`button`,{className:`pill-btn`,onClick:()=>he?ue(e):M(e),style:{...Ce(he?O.includes(e):A[S]===e),animation:`pillIn 0.32s ease both`,animationDelay:`${t*80}ms`},children:e},e))}),he&&pe?.hasOther&&O.includes(`Other`)&&(0,Y.jsx)(`input`,{className:`other-input`,type:`text`,value:ie,onChange:e=>ae(e.target.value),placeholder:`Please specify your condition`,style:{width:`100%`,boxSizing:`border-box`,marginTop:10,background:`rgba(255,255,255,0.04)`,border:`1px solid rgba(96,165,250,0.3)`,color:`#E2E8F0`,padding:`12px 16px`,fontSize:11,fontFamily:Ml,fontWeight:300,letterSpacing:`0.06em`,outline:`none`,borderRadius:0,transition:`border-color 0.3s ease`}}),he&&(0,Y.jsx)(`div`,{style:{marginTop:10},children:(0,Y.jsx)(`button`,{className:O.length>0?`q-pulse`:``,onClick:N,style:we(O.length>0),children:`NEXT →`})})]})]})})]}),h===`complete`&&(0,Y.jsxs)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,pointerEvents:`none`},children:[(0,Y.jsx)(`p`,{style:{fontSize:10,letterSpacing:`0.34em`,color:`#60A5FA`,fontFamily:Ml,fontWeight:400,margin:0,textShadow:`0 0 28px rgba(96,165,250,0.7)`},children:oe}),oe.length>0&&(0,Y.jsx)(`div`,{style:{display:`flex`,gap:8,marginTop:24},children:[0,1,2].map(e=>(0,Y.jsx)(`div`,{style:{width:5,height:5,borderRadius:`50%`,background:`#3B82F6`,animation:`dotBounce 1.2s ease-in-out ${e*.2}s infinite`}},e))})]})]})}function X({size:e=40}){let t=e,n=t/2,r=t/2,i=[[n,r-t*.38],[n+t*.33,r-t*.19],[n+t*.33,r+t*.19],[n,r+t*.38],[n-t*.33,r+t*.19],[n-t*.33,r-t*.19]];return(0,Y.jsxs)(`svg`,{width:t,height:t,viewBox:`0 0 ${t} ${t}`,fill:`none`,children:[i.map((e,n)=>{let r=i[(n+1)%i.length];return(0,Y.jsx)(`line`,{x1:e[0],y1:e[1],x2:r[0],y2:r[1],stroke:`#60A5FA`,strokeWidth:t*.04,opacity:`0.9`},`l${n}`)}),(0,Y.jsx)(`line`,{x1:i[0][0],y1:i[0][1],x2:i[3][0],y2:i[3][1],stroke:`#93C5FD`,strokeWidth:t*.025,opacity:`0.35`}),(0,Y.jsx)(`line`,{x1:i[1][0],y1:i[1][1],x2:i[4][0],y2:i[4][1],stroke:`#93C5FD`,strokeWidth:t*.025,opacity:`0.35`}),(0,Y.jsx)(`line`,{x1:i[2][0],y1:i[2][1],x2:i[5][0],y2:i[5][1],stroke:`#93C5FD`,strokeWidth:t*.025,opacity:`0.35`}),i.map((e,n)=>(0,Y.jsx)(`circle`,{cx:e[0],cy:e[1],r:t*.07,fill:`#60A5FA`},`c${n}`)),(0,Y.jsx)(`circle`,{cx:n,cy:r,r:t*.09,fill:`#3B82F6`})]})}function Fl({label:e,type:t=`text`,value:n,onChange:r,placeholder:i,options:a}){let[o,s]=(0,_.useState)(!1),c={width:`100%`,background:`rgba(255,255,255,0.04)`,border:`1px solid ${o?`rgba(96,165,250,0.85)`:`rgba(96,165,250,0.28)`}`,boxShadow:o?`0 0 18px rgba(96,165,250,0.14), inset 0 0 10px rgba(96,165,250,0.04)`:`none`,color:`#E2E8F0`,padding:`13px 16px`,fontSize:12,letterSpacing:`0.06em`,fontFamily:`'Inter', 'Helvetica Neue', sans-serif`,fontWeight:300,outline:`none`,borderRadius:0,boxSizing:`border-box`,transition:`border-color 0.3s ease, box-shadow 0.3s ease`,width:`100%`};return(0,Y.jsxs)(`div`,{style:{marginBottom:18,width:`100%`},children:[(0,Y.jsx)(`div`,{style:{fontSize:9,letterSpacing:`0.22em`,color:`rgba(147,197,253,0.6)`,fontFamily:`'Inter', sans-serif`,fontWeight:400,marginBottom:7,textTransform:`uppercase`},children:e}),a?(0,Y.jsxs)(`select`,{value:n,onChange:e=>r(e.target.value),onFocus:()=>s(!0),onBlur:()=>s(!1),style:{...c,appearance:`none`,cursor:`pointer`},children:[(0,Y.jsx)(`option`,{value:``,disabled:!0,style:{background:`#040c1a`},children:i}),a.map(e=>(0,Y.jsx)(`option`,{value:e.value,style:{background:`#040c1a`,color:`#E2E8F0`},children:e.label},e.value))]}):(0,Y.jsx)(`input`,{type:t,value:n,onChange:e=>r(e.target.value),placeholder:i,onFocus:()=>s(!0),onBlur:()=>s(!1),style:c})]})}function Z({current:e,total:t=3}){return(0,Y.jsx)(`div`,{style:{display:`flex`,gap:8,justifyContent:`center`,marginBottom:32},children:Array.from({length:t},(t,n)=>(0,Y.jsx)(`div`,{style:{width:n===e-1?22:6,height:6,borderRadius:3,background:n===e-1?`#60A5FA`:`rgba(96,165,250,0.22)`,transition:`all 0.45s ease`,boxShadow:n===e-1?`0 0 10px rgba(96,165,250,0.5)`:`none`}},n))})}function Q({onClick:e}){let[t,n]=(0,_.useState)(!1);return(0,Y.jsx)(`button`,{onClick:e,onMouseEnter:()=>n(!0),onMouseLeave:()=>n(!1),style:{background:`none`,border:`none`,color:t?`rgba(147,197,253,0.85)`:`rgba(147,197,253,0.38)`,fontSize:9,letterSpacing:`0.22em`,fontFamily:`'Inter', sans-serif`,cursor:`pointer`,marginBottom:20,padding:0,display:`flex`,alignItems:`center`,gap:6,transition:`color 0.25s ease`},children:`← BACK`})}var Il={background:`rgba(4,12,26,0.75)`,border:`1px solid rgba(96,165,250,0.16)`,backdropFilter:`blur(22px)`,WebkitBackdropFilter:`blur(22px)`,padding:`40px 44px 44px`,width:400,boxSizing:`border-box`,pointerEvents:`all`},Ll={width:`100%`,background:`transparent`,border:`1px solid rgba(96,165,250,0.4)`,color:`#93C5FD`,padding:`13px 0`,fontSize:10,letterSpacing:`0.3em`,textIndent:`0.3em`,fontFamily:`'Inter', 'Helvetica Neue', sans-serif`,fontWeight:400,borderRadius:0,cursor:`pointer`,marginTop:6},Rl={color:`#FFFFFF`,fontSize:19,fontWeight:800,letterSpacing:`0.24em`,textIndent:`0.24em`,margin:`0 0 6px 0`,textAlign:`center`,fontFamily:`'Montserrat', sans-serif`,textShadow:`0 0 28px rgba(37,99,235,0.45)`},zl={color:`rgba(147,197,253,0.5)`,fontSize:9,letterSpacing:`0.2em`,textIndent:`0.2em`,textAlign:`center`,marginBottom:28,fontFamily:`'Inter', sans-serif`,fontWeight:400};function Bl(){return(0,Y.jsxs)(`svg`,{width:`16`,height:`16`,viewBox:`0 0 18 18`,fill:`none`,children:[(0,Y.jsx)(`path`,{d:`M17.64 9.2c0-.637-.057-1.251-.164-1.84H9v3.481h4.844c-.209 1.125-.843 2.078-1.796 2.717v2.258h2.908c1.702-1.567 2.684-3.875 2.684-6.615z`,fill:`#4285F4`,opacity:`0.85`}),(0,Y.jsx)(`path`,{d:`M9 18c2.43 0 4.467-.806 5.956-2.18l-2.908-2.259c-.806.54-1.837.86-3.048.86-2.344 0-4.328-1.584-5.036-3.711H.957v2.332A8.997 8.997 0 0 0 9 18z`,fill:`#34A853`,opacity:`0.85`}),(0,Y.jsx)(`path`,{d:`M3.964 10.71A5.41 5.41 0 0 1 3.682 9c0-.593.102-1.17.282-1.71V4.958H.957A8.996 8.996 0 0 0 0 9c0 1.452.348 2.827.957 4.042l3.007-2.332z`,fill:`#FBBC05`,opacity:`0.85`}),(0,Y.jsx)(`path`,{d:`M9 3.58c1.321 0 2.508.454 3.44 1.345l2.582-2.58C13.463.891 11.426 0 9 0A8.997 8.997 0 0 0 .957 4.958L3.964 7.29C4.672 5.163 6.656 3.58 9 3.58z`,fill:`#EA4335`,opacity:`0.85`})]})}function Vl(){return(0,Y.jsx)(`svg`,{width:`15`,height:`16`,viewBox:`0 0 14 17`,fill:`none`,children:(0,Y.jsx)(`path`,{d:`M13.148 13.168c-.28.644-.612 1.237-.997 1.783-.525.748-0.954 1.266-1.282 1.554-.512.471-1.06.712-1.648.726-.422 0-.93-.12-1.52-.362-.593-.243-1.138-.363-1.638-.363-.525 0-1.086.12-1.685.363-.6.242-1.084.369-1.454.382-.564.024-1.126-.224-1.687-.745-.357-.311-.804-.847-1.341-1.607-.575-.81-1.047-1.749-1.417-2.818C.16 11.083 0 10.048 0 9.045c0-1.152.249-2.144.748-2.974.392-.667.913-1.193 1.565-1.58.652-.386 1.356-.583 2.115-.597.415 0 .96.128 1.638.38.676.254 1.11.382 1.299.382.143 0 .626-.15 1.444-.449.774-.278 1.427-.393 1.963-.347 1.451.117 2.542.69 3.268 1.721-1.297.786-1.939 1.887-1.926 3.298.012 1.1.411 2.016 1.193 2.742.355.337.751.597 1.192.782-.096.277-.196.543-.303.795zM10.15.34c0 .862-.315 1.667-.942 2.412-.757.884-1.674 1.394-2.667 1.314a2.675 2.675 0 0 1-.02-.327c0-.827.36-1.712 1-2.44C7.848.97 8.31.665 8.894.42c.582-.242 1.133-.376 1.65-.4.013.108.018.214.018.32H10.15z`,fill:`#E2E8F0`,opacity:`0.75`})})}function Hl({label:e,options:t,value:n,onChange:r}){return(0,Y.jsxs)(`div`,{style:{marginBottom:18},children:[(0,Y.jsx)(`div`,{style:{fontSize:9,letterSpacing:`0.22em`,color:`rgba(147,197,253,0.6)`,fontFamily:`'Inter', sans-serif`,fontWeight:400,marginBottom:10},children:e}),(0,Y.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:8},children:t.map(e=>{let t=n===e.value;return(0,Y.jsxs)(`button`,{onClick:()=>r(e.value),style:{background:t?`rgba(59,130,246,0.12)`:`rgba(255,255,255,0.025)`,border:`1px solid ${t?`rgba(96,165,250,0.65)`:`rgba(96,165,250,0.13)`}`,boxShadow:t?`0 0 20px rgba(96,165,250,0.18), inset 0 0 8px rgba(96,165,250,0.05)`:`none`,color:t?`#93C5FD`:`rgba(147,197,253,0.4)`,padding:`14px 8px 12px`,cursor:`pointer`,borderRadius:0,display:`flex`,flexDirection:`column`,alignItems:`center`,gap:8,transition:`all 0.22s ease`,fontFamily:`'Inter', sans-serif`,boxSizing:`border-box`,width:`100%`},children:[(0,Y.jsx)(`span`,{style:{display:`flex`,alignItems:`center`,opacity:t?1:.5,transition:`opacity 0.22s ease`},children:e.icon}),(0,Y.jsx)(`span`,{style:{fontSize:8,letterSpacing:`0.2em`,fontWeight:400},children:e.label.toUpperCase()})]},e.value)})})]})}function Ul({phoneCode:e,onCodeChange:t,value:n,onChange:r}){let[i,a]=(0,_.useState)(!1),o=[`+1`,`+44`,`+61`,`+33`,`+49`,`+34`,`+39`,`+81`,`+86`,`+91`,`+55`,`+52`],s=i?`rgba(96,165,250,0.85)`:`rgba(96,165,250,0.28)`,c=i?`0 0 18px rgba(96,165,250,0.14), inset 0 0 10px rgba(96,165,250,0.04)`:`none`,l={background:`transparent`,color:`#E2E8F0`,fontSize:12,letterSpacing:`0.06em`,fontFamily:`'Inter', 'Helvetica Neue', sans-serif`,fontWeight:300,outline:`none`,border:`none`,transition:`border-color 0.3s ease`};return(0,Y.jsxs)(`div`,{style:{marginBottom:18,width:`100%`},children:[(0,Y.jsx)(`div`,{style:{fontSize:9,letterSpacing:`0.22em`,color:`rgba(147,197,253,0.6)`,fontFamily:`'Inter', sans-serif`,fontWeight:400,marginBottom:7},children:`PHONE NUMBER`}),(0,Y.jsxs)(`div`,{style:{display:`flex`,background:`rgba(255,255,255,0.04)`,border:`1px solid ${s}`,boxShadow:c,transition:`border-color 0.3s ease, box-shadow 0.3s ease`},children:[(0,Y.jsx)(`select`,{value:e,onChange:e=>t(e.target.value),onFocus:()=>a(!0),onBlur:()=>a(!1),style:{...l,borderRight:`1px solid rgba(96,165,250,0.18)`,padding:`13px 6px 13px 14px`,appearance:`none`,WebkitAppearance:`none`,cursor:`pointer`,flexShrink:0,width:66},children:o.map(e=>(0,Y.jsx)(`option`,{value:e,style:{background:`#040c1a`,color:`#E2E8F0`},children:e},e))}),(0,Y.jsx)(`input`,{type:`tel`,value:n,onChange:e=>r(e.target.value),placeholder:`(555) 000-0000`,onFocus:()=>a(!0),onBlur:()=>a(!1),style:{...l,padding:`13px 16px`,flex:1,boxSizing:`border-box`}})]})]})}function Wl({icon:e,label:t}){let[n,r]=(0,_.useState)(!1);return(0,Y.jsxs)(`button`,{onMouseEnter:()=>r(!0),onMouseLeave:()=>r(!1),style:{width:`100%`,display:`flex`,alignItems:`center`,gap:12,background:n?`rgba(96,165,250,0.07)`:`rgba(255,255,255,0.03)`,border:`1px solid ${n?`rgba(96,165,250,0.45)`:`rgba(96,165,250,0.18)`}`,boxShadow:n?`0 0 14px rgba(96,165,250,0.1)`:`none`,color:`rgba(147,197,253,0.75)`,padding:`11px 16px`,fontSize:10,letterSpacing:`0.2em`,fontFamily:`'Inter', 'Helvetica Neue', sans-serif`,fontWeight:400,borderRadius:0,cursor:`pointer`,transition:`background 0.25s ease, border-color 0.25s ease, box-shadow 0.25s ease`,boxSizing:`border-box`},children:[(0,Y.jsx)(`span`,{style:{display:`flex`,alignItems:`center`,flexShrink:0},children:e}),(0,Y.jsx)(`span`,{style:{flex:1,textAlign:`center`,paddingRight:28},children:t})]})}function Gl(){let e=(0,_.useRef)(null),[t,n]=(0,_.useState)(0),[r,i]=(0,_.useState)(!1),[a,o]=(0,_.useState)({email:``,password:``,firstName:``,lastName:``,phone:``,phoneCode:`+1`,role:``,goal:``}),[s,c]=(0,_.useState)(!1),[l,u]=(0,_.useState)(!1),[d,f]=(0,_.useState)(null);(0,_.useEffect)(()=>{let t=e.current;if(!t)return;let n=t.clientWidth,r=t.clientHeight,a=new Ln;a.background=new Pn(265242),a.fog=new In(265242,.055);let o=new Ha(52,n/r,.1,100);o.position.set(0,.5,11.2),o.lookAt(0,0,0);let s=new Sl({antialias:!0});s.setSize(n,r),s.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.appendChild(s.domElement);let c=new Dn;a.add(c);let l=2.05,u=10.2,d=e=>{let t=[];for(let n=0;n<28;n++){let r=n/27,i=r*Math.PI*2*2.6+e;t.push(new H(l*Math.cos(i),r*u-u/2,l*Math.sin(i)))}return t},f=d(0),p=d(Math.PI),m=new Hr({color:1718927,transparent:!0,opacity:.45});[f,p].forEach(e=>{let t=new Vi(e,!1,`catmullrom`,.15);c.add(new ei(new sa(t,180,.042,7,!1),m))});let h=[3900150,6333946,8490232,3900150,6333946,8490232],g=[.14,.17,.13,.16,.13,.16];[f,p].forEach((e,t)=>{e.forEach((e,n)=>{let r=(n+t*3)%h.length,i=g[r],a=h[r],o=new ei(new oa(i*3.2,12,10),new Hr({color:662074,transparent:!0,opacity:.38,blending:1,depthWrite:!1}));o.position.copy(e),c.add(o);let s=new ei(new oa(i*1.9,12,10),new Hr({color:a,transparent:!0,opacity:.07,blending:2,depthWrite:!1}));s.position.copy(e),c.add(s);let l=new ei(new oa(i,14,12),new Hr({color:a}));l.position.copy(e),c.add(l);let u=new ei(new oa(i*.38,8,6),new Hr({color:14412542,transparent:!0,opacity:.38}));u.position.set(e.x-i*.28,e.y+i*.28,e.z+i*.18),c.add(u)})});let _=new fi({color:6333946,transparent:!0,opacity:.22});for(let e=0;e<28;e+=3){c.add(new bi(new jr().setFromPoints([f[e],p[e]]),_));let t=new H().addVectors(f[e],p[e]).multiplyScalar(.5),n=new ei(new oa(.05,8,6),new Hr({color:9684477,transparent:!0,opacity:.5}));n.position.copy(t),c.add(n)}let v=new Float32Array(540);for(let e=0;e<180;e++)v[e*3]=(Math.random()-.5)*20,v[e*3+1]=(Math.random()-.5)*16,v[e*3+2]=(Math.random()-.5)*10;let y=new jr;y.setAttribute(`position`,new gr(v,3)),a.add(new Di(y,new Si({color:6333946,size:.022,transparent:!0,opacity:.18,blending:2,depthWrite:!1}))),setTimeout(()=>i(!0),300);let b,x=0,S=()=>{b=requestAnimationFrame(S),x+=.005,c.rotation.y=x*.25,c.position.y=Math.sin(x*.32)*.15,o.position.x=Math.sin(x*.07)*.3,o.lookAt(0,0,0),s.render(a,o)};S();let C=()=>{if(!t)return;let e=t.clientWidth,n=t.clientHeight;o.aspect=e/n,o.updateProjectionMatrix(),s.setSize(e,n)};return window.addEventListener(`resize`,C),()=>{cancelAnimationFrame(b),window.removeEventListener(`resize`,C),s.dispose(),t.contains(s.domElement)&&t.removeChild(s.domElement)}},[]);let p=(0,_.useCallback)(e=>{i(!1),setTimeout(()=>{n(e),i(!0)},380)},[]),m=e=>t=>o(n=>({...n,[e]:t})),h=(e=0)=>({opacity:r?1:0,transform:r?`translateY(0)`:`translateY(12px)`,transition:`opacity 0.85s ease ${e}s, transform 0.85s ease ${e}s`}),g=(e,t=0)=>({overflow:`hidden`,maxHeight:e?`500px`:`0px`,opacity:e?1:0,transition:`max-height 0.52s ease ${t}s, opacity 0.35s ease ${e?t+.1:0}s`,pointerEvents:e?`all`:`none`}),v={0:(0,Y.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`},children:[(0,Y.jsx)(`div`,{style:{marginBottom:22,...h(0)},children:(0,Y.jsx)(X,{size:40})}),(0,Y.jsx)(`h1`,{style:{color:`#FFFFFF`,fontSize:52,fontWeight:800,letterSpacing:`0.32em`,textIndent:`0.32em`,margin:0,fontFamily:`'Montserrat', 'Helvetica Neue', sans-serif`,textShadow:`0 0 40px rgba(37,99,235,0.45), 0 2px 8px rgba(0,0,0,0.95)`,...h(.3)},children:`PEPTI AI`}),(0,Y.jsx)(`p`,{className:`pepti-sub`,style:{color:`#93C5FD`,fontSize:11,letterSpacing:`0.28em`,textIndent:`0.28em`,marginTop:14,marginBottom:0,fontWeight:400,fontFamily:`'Inter', 'Helvetica Neue', sans-serif`,...h(.6)},children:`PEPTIDE CONSULTING`}),(0,Y.jsx)(`div`,{style:{marginTop:42,pointerEvents:`all`,...h(.9)},children:(0,Y.jsx)(`button`,{className:`pepti-enter`,onClick:()=>p(1),style:{background:`transparent`,border:`1px solid rgba(96,165,250,0.4)`,color:`#93C5FD`,padding:`14px 52px`,fontSize:11,letterSpacing:`0.28em`,textIndent:`0.28em`,fontFamily:`'Inter', 'Helvetica Neue', sans-serif`,fontWeight:400,borderRadius:0,cursor:`pointer`,transition:`background 0.3s ease, color 0.3s ease`},children:`BUILD YOUR PROTOCOL`})})]}),1:(()=>{let e=a.email.trim().length>0&&a.password.length>=6;return(0,Y.jsxs)(`div`,{style:Il,children:[(0,Y.jsx)(`div`,{style:h(0),children:(0,Y.jsx)(Z,{current:1})}),(0,Y.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,marginBottom:18,...h(.05)},children:(0,Y.jsx)(X,{size:26})}),(0,Y.jsx)(`h2`,{style:{...Rl,...h(.1)},children:`CREATE ACCOUNT`}),(0,Y.jsx)(`p`,{style:{...zl,...h(.15)},children:`BEGIN YOUR PROTOCOL JOURNEY`}),(0,Y.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:10,...h(.2)},children:[(0,Y.jsx)(Wl,{icon:(0,Y.jsx)(Bl,{}),label:`CONTINUE WITH GOOGLE`}),(0,Y.jsx)(Wl,{icon:(0,Y.jsx)(Vl,{}),label:`CONTINUE WITH APPLE`})]}),(0,Y.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12,margin:`20px 0`,...h(.28)},children:[(0,Y.jsx)(`div`,{style:{flex:1,height:1,background:`rgba(96,165,250,0.12)`}}),(0,Y.jsx)(`span`,{style:{fontSize:9,letterSpacing:`0.28em`,color:`rgba(147,197,253,0.38)`,fontFamily:`'Inter', sans-serif`,fontWeight:400},children:`OR`}),(0,Y.jsx)(`div`,{style:{flex:1,height:1,background:`rgba(96,165,250,0.12)`}})]}),(0,Y.jsx)(`div`,{style:h(.34),children:(0,Y.jsx)(Fl,{label:`Email Address`,type:`email`,value:a.email,onChange:m(`email`),placeholder:`you@domain.com`})}),(0,Y.jsx)(`div`,{style:h(.4),children:(0,Y.jsx)(Fl,{label:`Password`,type:`password`,value:a.password,onChange:m(`password`),placeholder:`Min. 6 characters`})}),(0,Y.jsx)(`div`,{style:h(.46),children:(0,Y.jsx)(`button`,{className:e?`pepti-enter`:``,onClick:()=>{e&&p(2)},style:{...Ll,marginTop:0,opacity:e?1:.28,borderColor:e?`rgba(96,165,250,0.4)`:`rgba(96,165,250,0.12)`,color:e?`#93C5FD`:`rgba(147,197,253,0.28)`,cursor:e?`pointer`:`default`,transition:`opacity 0.45s ease, border-color 0.45s ease, color 0.45s ease`},children:`CONTINUE`})}),(0,Y.jsx)(`div`,{style:{textAlign:`center`,marginTop:18,...h(.52)},children:(0,Y.jsxs)(`span`,{style:{fontSize:10,color:`rgba(147,197,253,0.38)`,fontFamily:`'Inter', sans-serif`,letterSpacing:`0.08em`},children:[`Already have an account?`,` `,(0,Y.jsx)(`span`,{style:{color:`#60A5FA`,cursor:`pointer`},children:`Sign in`})]})})]})})(),2:(()=>{let e=a.firstName.trim(),t=a.lastName.trim(),n=a.phone.trim().replace(/\D/g,``).length,r=e&&t&&n>=9&&a.goal&&a.role;return(0,Y.jsxs)(`div`,{className:`pepti-scroll`,style:{...Il,maxHeight:`88vh`,overflowY:`auto`,overflowX:`hidden`,scrollbarWidth:`none`},children:[(0,Y.jsxs)(`div`,{style:h(0),children:[(0,Y.jsx)(Q,{onClick:()=>p(1)}),(0,Y.jsx)(Z,{current:2})]}),(0,Y.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,marginBottom:14,...h(.05)},children:(0,Y.jsx)(X,{size:26})}),(0,Y.jsx)(`h2`,{style:{...Rl,...h(.1)},children:`YOUR PROFILE`}),(0,Y.jsx)(`p`,{style:{...zl,marginBottom:10,...h(.15)},children:`YOUR PROTOCOL STARTS WITH KNOWING YOU`}),(0,Y.jsx)(`div`,{style:{textAlign:`center`,minHeight:22,marginBottom:16,fontSize:11,fontFamily:`'Inter', sans-serif`,fontWeight:300,letterSpacing:`0.1em`,color:`#60A5FA`,opacity:e?1:0,transform:e?`translateY(0)`:`translateY(5px)`,transition:`opacity 0.5s ease, transform 0.5s ease`,textShadow:`0 0 18px rgba(96,165,250,0.45)`},children:e?`Nice to meet you, ${a.firstName} ✦`:`\xA0`}),(0,Y.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`1fr 1fr`,gap:`0 14px`,...h(.2)},children:[(0,Y.jsx)(Fl,{label:`First Name`,value:a.firstName,onChange:m(`firstName`),placeholder:`John`}),(0,Y.jsx)(Fl,{label:`Last Name`,value:a.lastName,onChange:m(`lastName`),placeholder:`Doe`})]}),(0,Y.jsx)(`div`,{style:g(e&&t),children:(0,Y.jsx)(Ul,{phoneCode:a.phoneCode,onCodeChange:m(`phoneCode`),value:a.phone,onChange:m(`phone`)})}),(0,Y.jsx)(`div`,{style:g(n>=9),children:(0,Y.jsx)(Hl,{label:`PRIMARY GOAL`,value:a.goal,onChange:m(`goal`),options:[{value:`performance`,label:`Performance`,icon:(0,Y.jsxs)(`svg`,{width:`20`,height:`20`,viewBox:`0 0 20 20`,fill:`none`,children:[(0,Y.jsx)(`polyline`,{points:`2,14 6,9 10,11 14,5 18,8`,stroke:`currentColor`,strokeWidth:`1.4`,strokeLinecap:`round`,strokeLinejoin:`round`}),(0,Y.jsx)(`circle`,{cx:`18`,cy:`8`,r:`1.5`,fill:`currentColor`})]})},{value:`recovery`,label:`Recovery`,icon:(0,Y.jsx)(`svg`,{width:`20`,height:`19`,viewBox:`0 0 20 19`,fill:`none`,children:(0,Y.jsx)(`path`,{d:`M10 17C10 17 2 12 2 6.5A4.5 4.5 0 0 1 10 4.5A4.5 4.5 0 0 1 18 6.5C18 12 10 17 10 17Z`,stroke:`currentColor`,strokeWidth:`1.4`,strokeLinecap:`round`,strokeLinejoin:`round`})})},{value:`longevity`,label:`Longevity`,icon:(0,Y.jsx)(`svg`,{width:`24`,height:`14`,viewBox:`0 0 24 14`,fill:`none`,children:(0,Y.jsx)(`path`,{d:`M1 7C3 1 8 1 12 7C16 13 21 13 23 7`,stroke:`currentColor`,strokeWidth:`1.4`,strokeLinecap:`round`})})},{value:`weightloss`,label:`Weight Loss`,icon:(0,Y.jsxs)(`svg`,{width:`20`,height:`20`,viewBox:`0 0 20 20`,fill:`none`,children:[(0,Y.jsx)(`line`,{x1:`10`,y1:`3`,x2:`10`,y2:`15`,stroke:`currentColor`,strokeWidth:`1.4`,strokeLinecap:`round`}),(0,Y.jsx)(`polyline`,{points:`5,10 10,15 15,10`,stroke:`currentColor`,strokeWidth:`1.4`,strokeLinecap:`round`,strokeLinejoin:`round`})]})}]})}),(0,Y.jsx)(`div`,{style:g(!!a.goal),children:(0,Y.jsx)(Hl,{label:`I AM A`,value:a.role,onChange:m(`role`),options:[{value:`student`,label:`Student`,icon:(0,Y.jsxs)(`svg`,{width:`22`,height:`18`,viewBox:`0 0 22 18`,fill:`none`,children:[(0,Y.jsx)(`polygon`,{points:`11,2 21,7 11,12 1,7`,stroke:`currentColor`,strokeWidth:`1.3`,strokeLinejoin:`round`}),(0,Y.jsx)(`path`,{d:`M17 10V14C17 14 14.5 16 11 16C7.5 16 5 14 5 14V10`,stroke:`currentColor`,strokeWidth:`1.3`,strokeLinecap:`round`}),(0,Y.jsx)(`line`,{x1:`21`,y1:`7`,x2:`21`,y2:`12`,stroke:`currentColor`,strokeWidth:`1.3`,strokeLinecap:`round`})]})},{value:`athlete`,label:`Athlete`,icon:(0,Y.jsxs)(`svg`,{width:`20`,height:`20`,viewBox:`0 0 20 20`,fill:`none`,children:[(0,Y.jsx)(`circle`,{cx:`10`,cy:`4`,r:`2`,stroke:`currentColor`,strokeWidth:`1.3`}),(0,Y.jsx)(`path`,{d:`M10 6L10 13M7 9L13 9M7 13L5 18M13 13L15 18`,stroke:`currentColor`,strokeWidth:`1.3`,strokeLinecap:`round`})]})},{value:`corporate`,label:`Corporate`,icon:(0,Y.jsxs)(`svg`,{width:`18`,height:`20`,viewBox:`0 0 18 20`,fill:`none`,children:[(0,Y.jsx)(`rect`,{x:`1`,y:`5`,width:`16`,height:`15`,stroke:`currentColor`,strokeWidth:`1.3`}),(0,Y.jsx)(`path`,{d:`M5 5V3C5 2 13 2 13 3V5`,stroke:`currentColor`,strokeWidth:`1.3`,strokeLinecap:`round`}),(0,Y.jsx)(`rect`,{x:`4`,y:`9`,width:`3`,height:`3`,stroke:`currentColor`,strokeWidth:`1`}),(0,Y.jsx)(`rect`,{x:`11`,y:`9`,width:`3`,height:`3`,stroke:`currentColor`,strokeWidth:`1`}),(0,Y.jsx)(`rect`,{x:`4`,y:`14`,width:`3`,height:`3`,stroke:`currentColor`,strokeWidth:`1`}),(0,Y.jsx)(`rect`,{x:`11`,y:`14`,width:`3`,height:`3`,stroke:`currentColor`,strokeWidth:`1`})]})},{value:`other`,label:`Other`,icon:(0,Y.jsxs)(`svg`,{width:`20`,height:`20`,viewBox:`0 0 20 20`,fill:`none`,children:[(0,Y.jsx)(`circle`,{cx:`10`,cy:`10`,r:`7`,stroke:`currentColor`,strokeWidth:`1.3`}),(0,Y.jsx)(`circle`,{cx:`7`,cy:`10`,r:`1`,fill:`currentColor`}),(0,Y.jsx)(`circle`,{cx:`10`,cy:`10`,r:`1`,fill:`currentColor`}),(0,Y.jsx)(`circle`,{cx:`13`,cy:`10`,r:`1`,fill:`currentColor`})]})}]})}),(0,Y.jsx)(`div`,{style:{marginTop:6,...h(.3)},children:(0,Y.jsx)(`button`,{className:r?`pepti-enter`:``,onClick:()=>{r&&p(3)},style:{...Ll,marginTop:0,opacity:r?1:.28,borderColor:r?`rgba(96,165,250,0.4)`:`rgba(96,165,250,0.12)`,color:r?`#93C5FD`:`rgba(147,197,253,0.28)`,cursor:r?`pointer`:`default`,transition:`opacity 0.45s ease, border-color 0.45s ease, color 0.45s ease`},children:`CONTINUE`})})]})})(),3:s?(0,Y.jsxs)(`div`,{style:{...Il,maxWidth:400},children:[(0,Y.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,marginBottom:22,...h(0)},children:(0,Y.jsx)(X,{size:26})}),(0,Y.jsx)(`h2`,{style:{...Rl,...h(.1)},children:`THANK YOU`}),(0,Y.jsx)(`p`,{style:{color:`rgba(147,197,253,0.55)`,fontSize:12,lineHeight:1.9,textAlign:`center`,margin:`18px 0 0`,fontFamily:`'Inter', sans-serif`,fontWeight:300,letterSpacing:`0.04em`,...h(.2)},children:`Thank you for your honesty. Pepti AI protocol recommendations are only available for adults 21 and older.`})]}):(0,Y.jsxs)(`div`,{style:{...Il,maxWidth:400},children:[(0,Y.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,marginBottom:22,...h(0)},children:(0,Y.jsx)(X,{size:26})}),(0,Y.jsx)(`h2`,{style:{...Rl,...h(.1)},children:`ONE QUICK THING`}),(0,Y.jsx)(`p`,{style:{color:`rgba(147,197,253,0.55)`,fontSize:12,lineHeight:1.9,textAlign:`center`,margin:`14px 0 32px`,fontFamily:`'Inter', sans-serif`,fontWeight:300,letterSpacing:`0.04em`,...h(.2)},children:`To access your peptide protocol, we need to confirm your age. Pepti AI is only available to adults 21 and older.`}),(0,Y.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:18,...h(.3)},children:[(0,Y.jsx)(`button`,{className:`pepti-enter`,onClick:()=>p(4),style:{...Ll,marginTop:0,width:`100%`,background:`rgba(37,99,235,0.18)`,borderColor:`rgba(96,165,250,0.55)`,color:`#DBEAFE`,fontWeight:600},children:`I AM 21 OR OLDER`}),(0,Y.jsx)(`button`,{onClick:()=>c(!0),style:{background:`none`,border:`none`,color:`rgba(226,232,240,0.6)`,fontSize:10,letterSpacing:`0.22em`,fontFamily:`'Inter', sans-serif`,fontWeight:400,cursor:`pointer`,padding:`4px 0`},children:`I AM UNDER 21`})]})]}),4:(0,Y.jsxs)(`div`,{style:{...Il,width:420},children:[(0,Y.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,marginBottom:18,...h(.05)},children:(0,Y.jsx)(X,{size:26})}),(0,Y.jsx)(`h2`,{style:{...Rl,fontSize:17,...h(.1)},children:`BEFORE YOUR ASSESSMENT`}),(0,Y.jsx)(`p`,{style:{color:`rgba(147,197,253,0.55)`,fontSize:12,lineHeight:1.9,textAlign:`center`,margin:`18px 0 30px`,fontFamily:`'Inter', sans-serif`,fontWeight:300,letterSpacing:`0.04em`,...h(.2)},children:`Pepti AI provides educational information only. Nothing on this platform constitutes medical advice, diagnosis, or treatment. All protocol recommendations are for informational purposes only and must be reviewed with a licensed healthcare provider before use. By proceeding you acknowledge and accept these terms.`}),(0,Y.jsx)(`div`,{style:h(.32),children:(0,Y.jsx)(`button`,{className:`pepti-enter`,onClick:()=>p(5),style:{...Ll,marginTop:0,letterSpacing:`0.22em`,fontSize:9},children:`I ACCEPT — BEGIN ASSESSMENT`})})]}),5:(0,Y.jsxs)(`div`,{style:{...Il,width:420},children:[(0,Y.jsxs)(`div`,{style:h(0),children:[(0,Y.jsx)(Q,{onClick:()=>p(4)}),(0,Y.jsx)(Z,{current:3})]}),(0,Y.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,marginBottom:18,...h(.05)},children:(0,Y.jsx)(X,{size:26})}),(0,Y.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`,marginBottom:18,...h(.1)},children:(0,Y.jsx)(`div`,{style:{border:`1px solid rgba(96,165,250,0.32)`,color:`#60A5FA`,fontSize:8,letterSpacing:`0.32em`,fontFamily:`'Inter', sans-serif`,padding:`5px 16px`,background:`rgba(59,130,246,0.07)`},children:`PEPTIDE PROTOCOL QUIZ`})}),(0,Y.jsxs)(`h2`,{style:{color:`#FFFFFF`,fontSize:21,fontWeight:800,letterSpacing:`0.18em`,textIndent:`0.18em`,margin:`0 0 14px 0`,textAlign:`center`,fontFamily:`'Montserrat', sans-serif`,textShadow:`0 0 32px rgba(37,99,235,0.55)`,lineHeight:1.45,...h(.15)},children:[`FIND YOUR OPTIMAL`,(0,Y.jsx)(`br`,{}),`PROTOCOL`]}),(0,Y.jsx)(`p`,{style:{color:`rgba(147,197,253,0.6)`,fontSize:12,lineHeight:1.85,textAlign:`center`,margin:`0 0 26px 0`,fontFamily:`'Inter', sans-serif`,fontWeight:300,letterSpacing:`0.03em`,...h(.2)},children:`Answer 8 science-backed questions and our AI will map your biology to a precision peptide stack — calibrated to your goals and physiology.`}),[[`◈`,`8 targeted questions  ·  ~3 minutes`],[`◈`,`AI-matched peptide sequences`],[`◈`,`Downloadable protocol report`]].map(([e,t],n)=>(0,Y.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12,marginBottom:11,...h(.27+n*.07)},children:[(0,Y.jsx)(`span`,{style:{color:`#3B82F6`,fontSize:9,flexShrink:0,opacity:.85},children:e}),(0,Y.jsx)(`span`,{style:{color:`rgba(147,197,253,0.65)`,fontSize:11,letterSpacing:`0.1em`,fontFamily:`'Inter', sans-serif`,fontWeight:300},children:t})]},n)),(0,Y.jsx)(`div`,{style:{height:1,background:`rgba(96,165,250,0.1)`,margin:`20px 0 22px`,...h(.48)}}),(0,Y.jsx)(`div`,{style:h(.52),children:(0,Y.jsx)(`button`,{className:`pepti-enter`,onClick:()=>u(!0),style:{...Ll,marginTop:0},children:`BEGIN QUIZ →`})})]})};return l?(0,Y.jsx)(Pl,{onComplete:e=>f(e)}):(0,Y.jsxs)(`div`,{style:{position:`relative`,width:`100%`,height:`100vh`,overflow:`hidden`,background:`#040c1a`},children:[(0,Y.jsx)(`div`,{ref:e,style:{position:`absolute`,inset:0}}),(0,Y.jsx)(`style`,{children:`
        @import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@700;800;900&family=Inter:wght@300;400&display=swap');
      ...
      `}),(0,Y.jsx)(`div`,{style:{position:`absolute`,inset:0,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,pointerEvents:`none`,padding:20},children:v[t]})]})}v.createRoot(document.getElementById(`root`)).render((0,Y.jsx)(_.StrictMode,{children:(0,Y.jsx)(Gl,{})}));